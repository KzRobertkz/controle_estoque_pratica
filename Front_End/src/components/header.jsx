      ...
      <div className="fixed top-0 left-0 right-0 mx-4 ">
        <div className="w-full bg-white shadow pl-7 pr-5 py-2 flex justify-between items-center text-sm z-50 rounded-lg">
          ...
          <div className="flex gap-6 items-center">
            ...
            {/* Botão de pesquisa com animação */}
            <div className={`transition-all duration-300 ease-in-out transform ${
              hideSearch ? 'opacity-0 scale-95 w-0 -translate-x-1' : 'opacity-100 scale-100 w-auto'
            }`}>
              <button
            ...
            <div className={`transition-all duration-300 ease-in-out transform ${
              hideSearch ? 'opacity-0 scale-95 w-0 -translate-x-4' : 'opacity-100 scale-100 w-auto'
            }`}>
              <div
